    ...
    <div class="container-menu">
        ...
        <div class="right-menu">
            <div class="left-part">
                <form action="index.php?quanly=timkiem" method="POST" class="search-form">
                    <div class="input-holder">
                        ...
                        <button type="submit" class="search-icon" name="timkiem"><i
            ...
            <div class="right-part">
                <button type="submit" class="giohang-btn" onclick="window.location.href='index.php?quanly=giohang'"><i
                        class="fa-solid fa-cart-shopping fa-2xl" style="color: #ffffff;"></i></button>
                <?php
                ...
                ?>
                <button onclick="window.location.href='index.php?quanly=dangky'" class="btn-register btn">Đăng
                    kí</button>
                <?php
                }
                ?>
